...
# Структура backend
- core - ядро. Общая функцианальность для всех проектов компании реализуется в нем. Функции свойственные только текущему проекту реализуются вне этой дирректории. Структура папок ядра совпадает со структрурой папок в корне backend:
...
- Выполняйте запрос к базе данных вне циклов — сразу для всех элементов, а внутри цикла лишь назначайте полученные значения.
